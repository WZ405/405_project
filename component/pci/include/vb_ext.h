...
{
    HI_S32 (*pfnVB_CreatePool)(HI_U32 *pu32PoolId,HI_U32 u32BlkCnt, HI_U64 u64BlkSize, HI_CHAR *pcMmzName, HI_CHAR *pBufName, VB_REMAP_MODE_E enVbRemapMode);
...
#define CKFN_VB_GetBlkBySizeAndPoolId() \
    (NULL != FUNC_ENTRY(VB_EXPORT_FUNC_S, HI_ID_VB)->pfnVB_GetBlkBySizeAndPoolId)
...
#define CKFN_VB_GetPoolId() \
    (NULL != FUNC_ENTRY(VB_EXPORT_FUNC_S, HI_ID_VB)->pfnVB_GetPoolId)
...
#define CKFN_VB_InquireTotalUserCnt() \
    (NULL != FUNC_ENTRY(VB_EXPORT_FUNC_S, HI_ID_VB)->pfnVB_InquireTotalUserCnt)
