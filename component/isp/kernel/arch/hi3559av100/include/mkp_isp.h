...
typedef enum hiIOC_NR_ISP_E
{
    ...
    IOC_NR_ISP_ATTACH_INFO_BUF_INIT,
    IOC_NR_ISP_ATTACH_INFO_BUF_EXIT,
    IOC_NR_ISP_COLORGAMUT_INFO_BUF_INIT,
    IOC_NR_ISP_COLORGAMUT_INFO_BUF_EXIT,
    IOC_NR_ISP_DNG_INFO_SET,
    IOC_NR_ISP_DNG_INFO_GET,
    IOC_NR_ISP_DNG_INFO_BUF_INIT,
    IOC_NR_ISP_DNG_INFO_BUF_EXIT,
    IOC_NR_ISP_PRO_NR_PARAM_BUF_INIT,
    IOC_NR_ISP_PRO_NR_PARAM_BUF_EXIT,
    IOC_NR_ISP_PRO_SHP_PARAM_BUF_INIT,
    IOC_NR_ISP_PRO_SHP_PARAM_BUF_EXIT,
...
{
    HI_U32  au32DehazeMaxStatDout[2][DEFOG_ZONE_NUM];
    HI_U32  au32DehazeMinDout[2][DEFOG_ZONE_NUM / 2];
} ISP_DEHAZE_STAT_S;
...
typedef struct hiISP_STITCH_STAT_S
{
...
typedef struct hiISP_STAT_S
{
    ...
    ISP_AWB_STAT_1_S    stAwbStat1;
    ISP_AWB_STAT_2_S    stAwbStat2;
    ISP_AF_STAT_S       stFEAfStat;
    ISP_AF_STAT_S       stBEAfStat;
    ISP_DP_STAT_S       stDpStat;
    ISP_COMM_STAT_S     stCommStat;
    ISP_DEHAZE_STAT_S   stDehazeStat;
    ISP_MG_STAT_S       stMgStat;
    ISP_STITCH_STAT_S   stStitchStat;
    HI_BOOL             bBEUpdate;
} ISP_STAT_S;
...
typedef struct hiISP_AE_STATIC_CFG_S
{
    ...
    HI_U8 u8FEBLCEnable;
    HI_U16 u16FEOffsetR;
    HI_U16 u16FEOffsetGR;
    HI_U16 u16FEOffsetGB;
    HI_U16 u16FEOffsetB;

    HI_U8 u8BEEnable;
    HI_U8 u8BEBLCEnable;
    HI_U16 u16BEOffsetR;
    HI_U16 u16BEOffsetGR;
    HI_U16 u16BEOffsetGB;
    HI_U16 u16BEOffsetB;
...
{
    //BE DYNAMIC
    HI_U32  au32BEWhiteBalanceGain[4];
...
typedef struct hiISP_AWB_REG_CFG_2_S
{
    ...
    HI_U8 u8BEWbWorkEn;
    HI_U8 u8BEWbBlcInEn;
    HI_U8 u8BEWbBlcOutEn;

    HI_U16 u16BEWbBlcOffset1;
    HI_U16 u16BEWbBlcOffset2;
    HI_U16 u16BEWbBlcOffset3;
    HI_U16 u16BEWbBlcOffset4;
    ...
    HI_U8 u8FEWbWorkEn;
    HI_U8 u8FEWbBlcInEn;
    HI_U8 u8FEWbBlcOutEn;

    HI_U16 u16FEWbBlcOffset1;
    HI_U16 u16FEWbBlcOffset2;
    HI_U16 u16FEWbBlcOffset3;
    HI_U16 u16FEWbBlcOffset4;
...
typedef struct hiISP_DRC_USR_CFG_S
{
    ...
    HI_U16  u16CCLUT[33];     //Color Correction LUT
...
typedef struct hiISP_DPC_DYNA_CFG_S
{
    ...
    HI_U16  au16DpccLineMadFac[3];  //U16.0
    HI_U16  au16DpccPgFac[3];       //U16.0
    HI_U16  au16DpccRndThr[3];      //U16.0
    HI_U16  au16DpccRgFac[3];       //U16.0
    HI_U32  u32DpccRoLimits;        //U12.0
    HI_U32  u32DpccRndOffs;         //U12.0
    HI_U32  u32DpccBadThresh;       //U32.0
    HI_U16  au16DpccLineStdThr[5];
    HI_U16  au16DpccLineDiffThr[5];
    HI_U16  au16DpccLineAverFac[5];
    HI_U16  u16DpccLineKerdiffFac;
    HI_U16  u16DpccBlendMode;
    HI_U16  u16DpccBitDepthSel;
...
typedef struct hiISP_SHARPEN_DEFAULT_DYNA_REG_CFG_S
{
    ...
    HI_S16   s16chrGMul;           //                                                         // 13-bit signed integer    // S9.4
...
typedef ISP_FSWDR_SYNC_CFG_S ISP_FSWDR_REG_CFG_2_S;
...
typedef struct hiISP_FLICKER_DYNA_CFG_S
{
    ...
    HI_U32  u32CntOverCur;      //U26       ro
    HI_S32  s32GrDiffCur;       //S23       ro
    HI_S32  s32GbDiffCur;       //S23       ro
    HI_U32  u32GrAbsCur;        //U23       ro
    HI_U32  u32GbAbsCur;        //U23       ro
    HI_S16  as16GrMean[512];    //S11       ro
    HI_S16  as16GbMean[512];    //S11       ro
...
typedef struct hiISP_BAYERNR_DYNA_CFG_S
{
    ...
    HI_U8   au8BnrCRatio[BAYER_PATT_NUM];       //u6.0
    HI_U8   au8AmedMode[BAYER_PATT_NUM];        //u1.0
    HI_U8   au8AmedLevel[BAYER_PATT_NUM];       //u2.0
...
typedef struct hiISP_LDCI_STATIC_CFG_S
{
    ...
    HI_U32  u32DehLpfSft;
    HI_U32  u32DehLpfCoefH[3];
    HI_U32  u32DehLpfCoefV[2];
    HI_U32  u32CalcPfmul;
    HI_U32  u32CalcPfOri[2];
    HI_U32  u32CalcPfSft[4];
    ...
    HI_U32  s32StatPolyP2[65];
    HI_U32  s32StatPolyP3[65];
    HI_U32  s32PolyP1[65];
    HI_U32  s32PolyQ0[65];
    HI_U32  s32PolyQ1[65];
    HI_U32  s32PolyQ2[65];
    HI_U32  s32PolyQ3[65];
    HI_U32  u32StatDynRngCmpLut[65];
    HI_U32  u32CalcDynRngCmpLut[65];
...
typedef struct hiISP_FE_BLC_CFG_S
{
    ...
    //ISP_BLC_REG_CFG_S stFeDisBlc;//only Gr & Gb
    ISP_BLC_REG_CFG_S stFeLscBlc;
    ISP_BLC_REG_CFG_S stRcBlc;
    ISP_BLC_REG_CFG_S stFeLogLUTBlc;
} ISP_FE_BLC_CFG_S;
...
typedef union hiISP_REG_KERNEL_CFG_KEY_U
{
    ...
    struct
    {
        ...
        HI_U32  bit1McdsCfg     : 1 ;   /* [0] */
        HI_U32  bit31Rsv        : 31;   /* [1:31] */
    };
...
typedef struct hiISP_BE_SYNC_PARA_S
{
    ...
    HI_U32  au32WdrExpRatio[SYNC_EXP_RATIO_NUM];
    HI_U32  au32FlickExpRatio[SYNC_EXP_RATIO_NUM];
    HI_U32  au32WdrExpVal[SYNC_WDR_EXP_VAL_NUM];
    HI_U32  au32WdrBlcComp[SYNC_WDR_BLC_COMP_NUM];
    HI_BOOL bWDRMdtEn;
    HI_U16  u16ShortThr;
    HI_U16  u16LongThr;
...
/* ISP BE statistics for offline mode */
typedef struct hiISP_BE_STT_BUF_S
{
    HI_U64  u64PhyAddr;
    HI_U64  u64Size;
    HI_VOID ATTRIBUTE *pVirAddr;
...
typedef struct
{
    ...
    ISP_BE_STT_BUF_S astBeSttBuf[2];   /* ping pong be online stt info */
...
typedef struct
{
    HI_BOOL bFirstFrame;
    HI_U32  u32CurWriteFlag;
    ISP_BE_STT_BUF_S astFeSttBuf[2];   /* ping pong fe stt info */
} ISP_FE_STT_INFO_S;

/* ISP BE stitch statistics for offline mode */
typedef struct hiISP_BE_STITCH_BUF_S
{
    HI_U64  u64PhyAddr;
    HI_U64  u64Size;
    HI_VOID ATTRIBUTE *pVirAddr;
...
typedef struct hiISP_SPECAWB_BUF_S
{
    HI_U64  u64PhyAddr;
    HI_U64  u64Size;
    HI_VOID ATTRIBUTE *pVirAddr;
...
typedef struct hiISP_SYNC_CFG_BUF_NODE_S
{
    ...
    ISP_FSWDR_REG_CFG_2_S stWDRRegCfg;
...
typedef struct hiISP_REGCFG_S
{
    ...
    ISP_REG_CFG_S stRegGet;
    ISP_BE_WO_REG_CFG_S stBeWoRegCfg;
...
#define ISP_SNAP_INFO_SET          _IOW(IOC_TYPE_ISP, IOC_NR_ISP_SNAP_INFO_SET, ISP_SNAP_INFO_S)
...
#define ISP_UPDATEINFO_BUF_INIT    _IOR(IOC_TYPE_ISP, IOC_NR_ISP_UPDATEINFO_BUF_INIT, HI_U64)
...
#define ISP_FRAME_INFO_BUF_INIT    _IOR(IOC_TYPE_ISP, IOC_NR_ISP_FRAME_INFO_BUF_INIT, HI_U64)
#define ISP_FRAME_INFO_BUF_EXIT    _IO(IOC_TYPE_ISP, IOC_NR_ISP_FRAME_INFO_BUF_EXIT)
#define ISP_ATTACH_INFO_BUF_INIT   _IOR(IOC_TYPE_ISP, IOC_NR_ISP_ATTACH_INFO_BUF_INIT, HI_U64)
#define ISP_ATTACH_INFO_BUF_EXIT   _IO(IOC_TYPE_ISP, IOC_NR_ISP_ATTACH_INFO_BUF_EXIT)

#define ISP_COLORGAMUT_INFO_BUF_INIT   _IOR(IOC_TYPE_ISP, IOC_NR_ISP_COLORGAMUT_INFO_BUF_INIT, HI_U64)
#define ISP_COLORGAMUT_INFO_BUF_EXIT   _IO(IOC_TYPE_ISP, IOC_NR_ISP_COLORGAMUT_INFO_BUF_EXIT)
...
#define ISP_DNG_INFO_BUF_INIT    _IOR(IOC_TYPE_ISP, IOC_NR_ISP_DNG_INFO_BUF_INIT, HI_U64)
#define ISP_DNG_INFO_BUF_EXIT    _IO(IOC_TYPE_ISP, IOC_NR_ISP_DNG_INFO_BUF_EXIT)
#define ISP_PRO_NR_PARAM_BUF_INIT   _IOR(IOC_TYPE_ISP, IOC_NR_ISP_PRO_NR_PARAM_BUF_INIT, HI_U64)
#define ISP_PRO_NR_PARAM_BUF_EXIT   _IO(IOC_TYPE_ISP, IOC_NR_ISP_PRO_NR_PARAM_BUF_EXIT)
#define ISP_PRO_SHP_PARAM_BUF_INIT   _IOR(IOC_TYPE_ISP, IOC_NR_ISP_PRO_SHP_PARAM_BUF_INIT, HI_U64)
#define ISP_PRO_SHP_PARAM_BUF_EXIT   _IO(IOC_TYPE_ISP, IOC_NR_ISP_PRO_SHP_PARAM_BUF_EXIT)
