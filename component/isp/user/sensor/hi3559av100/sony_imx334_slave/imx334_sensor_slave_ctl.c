 ...
 ******************************************************************************
  File Name     : imx334_sensor_slave_ctl.c
...
extern ISP_SNS_STATE_S    g_astImx334Slave[ISP_MAX_PIPE_NUM];
...
void imx334slave_init(VI_PIPE ViPipe)
{
    ...
    bInit       = g_astImx334Slave[ViPipe].bInit;
    u8ImgMode   = g_astImx334Slave[ViPipe].u8ImgMode;
    ...
    if (g_astImx334Slave[ViPipe].astRegsInfo[0].stSlvSync.u32SlaveVsTime == 0)
    {
        gstImx334Sync[ViPipe].u32VsTime = g_astImx334ModeTbl[u8ImgMode].u32InckPerVs;
    }
    else
    {
        gstImx334Sync[ViPipe].u32VsTime = g_astImx334Slave[ViPipe].astRegsInfo[0].stSlvSync.u32SlaveVsTime;
    }

    //printf("u32HsTime = %d u32VsTime = %d \n",gstImx334Sync[ViPipe].u32HsTime,gstImx334Sync[ViPipe].u32VsTime);
    ...
    if (HI_FALSE == bInit)
    {
        ...
        if (IMX334_8M30FPS_LINER_MODE == u8ImgMode)       /* 4K@30fps Linear */
        {
            imx334slave_linear_8M30_12bit_init(ViPipe);
        }
        else if (IMX334_8M30FPS_WDR_MODE == u8ImgMode)   /* 4K@30fps DOL2 */
        {
    ...
    for (i = 0; i < g_astImx334Slave[ViPipe].astRegsInfo[0].u32RegNum; i++)
    {
        imx334slave_write_register(ViPipe, g_astImx334Slave[ViPipe].astRegsInfo[0].astI2cData[i].u32RegAddr, g_astImx334Slave[ViPipe].astRegsInfo[0].astI2cData[i].u32Data);
    }

    g_astImx334Slave[ViPipe].bInit = HI_TRUE;
...
void imx334slave_DOL_2t1_8M30_12bit_init(VI_PIPE ViPipe)
{
...
#if 0
    imx334slave_write_register(ViPipe, 0x3058, 0x05);  //SHR0[7:0]
    imx334slave_write_register(ViPipe, 0x3059, 0x00);  //SHR0[15:8]
    ...
    imx334slave_write_register(ViPipe, 0x3068, 0x11);  //RHS1[7:0]
    imx334slave_write_register(ViPipe, 0x3069, 0x00);  //RHS1[15:8]
...
#if 0
    imx334slave_write_register(ViPipe, 0x3058, 0x90);  //SHR0[7:0]
    imx334slave_write_register(ViPipe, 0x3059, 0x11);  //SHR0[15:8]
    imx334slave_write_register(ViPipe, 0x305A, 0x00);  //SHR0[19:16]

    imx334slave_write_register(ViPipe, 0x305C, 0x0b);  //SHR1[7:0]
    imx334slave_write_register(ViPipe, 0x305D, 0x00);  //SHR1[15:8]
    imx334slave_write_register(ViPipe, 0x305E, 0x00);  //SHR1[19:16]
    ...
    imx334slave_write_register(ViPipe, 0x3068, 0x0d);  //RHS1[7:0]
    imx334slave_write_register(ViPipe, 0x3069, 0x00);  //RHS1[15:8]
    imx334slave_write_register(ViPipe, 0x306A, 0x00);  //RHS1[19:16]
    ...
    imx334slave_write_register(ViPipe, 0x31D7, 0x07); //XVSMSKCNT:[1:0]:1  [2:3]:1  [5:4]:1 [7:6]:0
...
void imx334slave_DOL_2t1_8M30_12bit_init(VI_PIPE ViPipe)
{
    imx334slave_write_register (ViPipe, 0x3000, 0x01);
    imx334slave_write_register (ViPipe, 0x3001, 0x00);
    imx334slave_write_register (ViPipe, 0x3002, 0x01);  //change
    imx334slave_write_register (ViPipe, 0x3001, 0x00);
    imx334slave_write_register (ViPipe, 0x3004, 0x00);
    imx334slave_write_register (ViPipe, 0x300C, 0x5b);
    imx334slave_write_register (ViPipe, 0x300D, 0x40);
    imx334slave_write_register (ViPipe, 0x3018, 0x00);
    imx334slave_write_register (ViPipe, 0x302C, 0x30);
    imx334slave_write_register (ViPipe, 0x302D, 0x00);
    imx334slave_write_register (ViPipe, 0x302E, 0x18);
    ...
    imx334slave_write_register (ViPipe, 0x3031, 0x08);
    imx334slave_write_register (ViPipe, 0x3032, 0x00);
    imx334slave_write_register (ViPipe, 0x3034, 0x26);   //change
    imx334slave_write_register (ViPipe, 0x3035, 0x02);   //change
    imx334slave_write_register (ViPipe, 0x3048, 0x01);
    imx334slave_write_register (ViPipe, 0x3049, 0x01);
    imx334slave_write_register (ViPipe, 0x304A, 0x01);
    imx334slave_write_register (ViPipe, 0x304B, 0x02);
    imx334slave_write_register (ViPipe, 0x304C, 0x13);
    imx334slave_write_register (ViPipe, 0x304E, 0x00);
    imx334slave_write_register (ViPipe, 0x304F, 0x00);
    imx334slave_write_register (ViPipe, 0x3050, 0x01);
    imx334slave_write_register (ViPipe, 0x3074, 0xb0);
    ...
    imx334slave_write_register (ViPipe, 0x30A4, 0x00);
    imx334slave_write_register (ViPipe, 0x30A5, 0x00);
    imx334slave_write_register (ViPipe, 0x314C, 0xc0);
    imx334slave_write_register (ViPipe, 0x314D, 0x00);
    imx334slave_write_register (ViPipe, 0x315A, 0x06);
    imx334slave_write_register (ViPipe, 0x3168, 0x68);
    imx334slave_write_register (ViPipe, 0x316A, 0x7e);
    imx334slave_write_register (ViPipe, 0x3199, 0x00);
    imx334slave_write_register (ViPipe, 0x319D, 0x01);
    imx334slave_write_register (ViPipe, 0x319E, 0x02);
    imx334slave_write_register (ViPipe, 0x319F, 0x01);
    imx334slave_write_register (ViPipe, 0x31A0, 0x2A);
    imx334slave_write_register (ViPipe, 0x31A1, 0x0F);
    imx334slave_write_register (ViPipe, 0x31d7, 0x15);   //change
    imx334slave_write_register (ViPipe, 0x3288, 0x21);
    imx334slave_write_register (ViPipe, 0x328A, 0x02);
    imx334slave_write_register (ViPipe, 0x3300, 0x00);
    imx334slave_write_register (ViPipe, 0x3302, 0x32);
    ...
    imx334slave_write_register (ViPipe, 0x3794, 0x7A);
    imx334slave_write_register (ViPipe, 0x3796, 0xA1);
    //imx334slave_write_register (ViPipe, 0x37B0, 0x36);
    imx334slave_write_register (ViPipe, 0x37B0, 0x37);

    imx334slave_write_register (ViPipe, 0x3A00, 0x01);
    imx334slave_write_register (ViPipe, 0x3A01, 0x07);
    imx334slave_write_register (ViPipe, 0x3A18, 0x7F);
    imx334slave_write_register (ViPipe, 0x3A19, 0x00);
    imx334slave_write_register (ViPipe, 0x3A1A, 0x37);
    imx334slave_write_register (ViPipe, 0x3A1B, 0x00);
    ...
    imx334slave_write_register (ViPipe, 0x3A29, 0x00);
    imx334slave_write_register (ViPipe, 0x3E04, 0x0E);
    imx334slave_write_register (ViPipe, 0x3058, 0x08);
    imx334slave_write_register (ViPipe, 0x3059, 0x13);
    imx334slave_write_register (ViPipe, 0x305A, 0x00);
    imx334slave_write_register (ViPipe, 0x305C, 0x09);
    imx334slave_write_register (ViPipe, 0x305D, 0x00);
    imx334slave_write_register (ViPipe, 0x305E, 0x00);
    imx334slave_write_register (ViPipe, 0x3068, 0x11);
    imx334slave_write_register (ViPipe, 0x3069, 0x00);
    imx334slave_write_register (ViPipe, 0x306A, 0x00);
    imx334slave_write_register (ViPipe, 0x3308, 0x8b);
    imx334slave_write_register (ViPipe, 0x3309, 0x08);
    imx334slave_write_register (ViPipe, 0x30E8, 0x00);
    imx334slave_write_register (ViPipe, 0x30E9, 0x00);
    imx334slave_write_register (ViPipe, 0x30D7, 0x01);
    imx334slave_write_register (ViPipe, 0x3060, 0x00);
    imx334slave_write_register (ViPipe, 0x3061, 0x00);
    imx334slave_write_register (ViPipe, 0x3062, 0x00);
    imx334slave_write_register (ViPipe, 0x306C, 0x00);
    imx334slave_write_register (ViPipe, 0x306D, 0x00);
    imx334slave_write_register (ViPipe, 0x306E, 0x00);
    ...
    delay_ms(20);
    // release stanby
    imx334slave_write_register (ViPipe, 0x3000, 0x00);
    delay_ms(20);
    ...
    printf("===Imx334 sensor 4K30fps 12bit 2to1 WDR(60fps->30fps) 8lane Slave Mode init success!=====\n");
