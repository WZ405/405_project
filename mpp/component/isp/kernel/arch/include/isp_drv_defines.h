...
#define ISP_INT_BE_MASK         0x100F8
#define ISP_INT_BE              0x100F0
#define ISP_INT_BE_FSTART       (1<<16)
...
#define ISP_PROC_SIZE           0x40000 /* 256KB */
...
#define IO_PT_ADDRESS(x)                    ((unsigned long)reg_vicap_base_va + (x))
#define IO_FE_ADDRESS(ViPipe, x)            ((unsigned long)reg_ispfe_base_va[ViPipe] + (x))
#define IO_BE_ADDRESS(PhyPipe, x)           ((unsigned long)reg_ispbe_base_va[PhyPipe] + (x))
