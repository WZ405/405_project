...
extern ISP_SNS_STATE_S              g_astImx290[ISP_MAX_PIPE_NUM];
...
void imx290_init(VI_PIPE ViPipe)
{
    ...
    bInit       = g_astImx290[ViPipe].bInit;
    enWDRMode   = g_astImx290[ViPipe].enWDRMode;
    u8ImgMode   = g_astImx290[ViPipe].u8ImgMode;
    ...
    for (i = 0; i < g_astImx290[ViPipe].astRegsInfo[0].u32RegNum; i++)
    {
        imx290_write_register(ViPipe, g_astImx290[ViPipe].astRegsInfo[0].astI2cData[i].u32RegAddr, g_astImx290[ViPipe].astRegsInfo[0].astI2cData[i].u32Data);
    }

    g_astImx290[ViPipe].bInit = HI_TRUE;
    return ;
}
...
void imx290_wdr_1080p60_2to1_init(VI_PIPE ViPipe)
{
#if 0
    imx290_write_register (ViPipe, 0x3000, 0x01); /* standby */
    imx290_write_register (ViPipe, 0x3002, 0x00); /* XTMSTA */
    ...
    imx290_write_register (ViPipe, 0x301c, 0x98); /* HMAX */
    imx290_write_register (ViPipe, 0x301d, 0x08); /* HMAX */
