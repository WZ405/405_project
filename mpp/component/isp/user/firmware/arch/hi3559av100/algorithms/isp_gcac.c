...
typedef struct hiISP_GCAC_S
{
    ...
    HI_U16  au16StartCoorHor[2];
    HI_U16  u16CenterCoorHor;
    HI_U16  u16CenterCoorVer;
    HI_U16  au16Width[2];
    HI_U16  u16Height;
    HI_U16  u16FullFrameWidth;

    HI_U16 u16CorVarThr;//[0,4095]   //edge
} ISP_GCAC_S;

ISP_GCAC_S g_astGlobalCacCtx[ISP_MAX_PIPE_NUM] = {{0}};

#define GlobalCAC_GET_CTX(dev, pstCtx)   pstCtx = &g_astGlobalCacCtx[dev]
