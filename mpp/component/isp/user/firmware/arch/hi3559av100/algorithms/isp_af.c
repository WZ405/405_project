...
{
    {
        {1, 17, 15, 1920, 1080, 1, 0, {0, 0, 0, 0, 0}, 0, {0x2, 0x4, 0}, {1, 0x9bff}, 0xf0},
...
HI_S32 ISP_EXT_AF_SetDefault(VI_PIPE ViPipe)
{
    HI_U8 u8I, u8Shift0;
    ...
    hi_ext_af_iir0_shift_write(ViPipe, g_stFocusCfg[ViPipe].stHParam_IIR0.u8IIRShift);
    hi_ext_af_iir1_shift_write(ViPipe, g_stFocusCfg[ViPipe].stHParam_IIR1.u8IIRShift);
    ...
    hi_ext_af_iir_gain0_group0_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR0.as16IIRGain[0]);
    hi_ext_af_iir_gain0_group1_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR1.as16IIRGain[0]);
    hi_ext_af_iir_gain1_group0_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR0.as16IIRGain[1]);
    hi_ext_af_iir_gain1_group1_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR1.as16IIRGain[1]);
    hi_ext_af_iir_gain2_group0_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR0.as16IIRGain[2]);
    hi_ext_af_iir_gain2_group1_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR1.as16IIRGain[2]);
    hi_ext_af_iir_gain3_group0_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR0.as16IIRGain[3]);
    hi_ext_af_iir_gain3_group1_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR1.as16IIRGain[3]);
    hi_ext_af_iir_gain4_group0_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR0.as16IIRGain[4]);
    hi_ext_af_iir_gain4_group1_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR1.as16IIRGain[4]);
    hi_ext_af_iir_gain5_group0_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR0.as16IIRGain[5]);
    hi_ext_af_iir_gain5_group1_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR1.as16IIRGain[5]);
    hi_ext_af_iir_gain6_group0_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR0.as16IIRGain[6]);
    hi_ext_af_iir_gain6_group1_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stHParam_IIR1.as16IIRGain[6]);
    ...
    hi_ext_af_fir_h_gain0_group0_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stVParam_FIR0.as16FIRH[0]);
    hi_ext_af_fir_h_gain0_group1_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stVParam_FIR1.as16FIRH[0]);
    hi_ext_af_fir_h_gain1_group0_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stVParam_FIR0.as16FIRH[1]);
    hi_ext_af_fir_h_gain1_group1_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stVParam_FIR1.as16FIRH[1]);
    hi_ext_af_fir_h_gain2_group0_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stVParam_FIR0.as16FIRH[2]);
    hi_ext_af_fir_h_gain2_group1_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stVParam_FIR1.as16FIRH[2]);
    hi_ext_af_fir_h_gain3_group0_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stVParam_FIR0.as16FIRH[3]);
    hi_ext_af_fir_h_gain3_group1_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stVParam_FIR1.as16FIRH[3]);
    hi_ext_af_fir_h_gain4_group0_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stVParam_FIR0.as16FIRH[4]);
    hi_ext_af_fir_h_gain4_group1_write(ViPipe, (HI_U32)g_stFocusCfg[ViPipe].stVParam_FIR1.as16FIRH[4]);
    ...
    hi_ext_af_crop_pos_x_write(ViPipe, g_stFocusCfg[ViPipe].stConfig.stCrop.u16X);
    hi_ext_af_crop_pos_y_write(ViPipe, g_stFocusCfg[ViPipe].stConfig.stCrop.u16Y);
    hi_ext_af_crop_hsize_write(ViPipe, g_stFocusCfg[ViPipe].stConfig.stCrop.u16W);
    hi_ext_af_crop_vsize_write(ViPipe, g_stFocusCfg[ViPipe].stConfig.stCrop.u16H);
    ...
    /* high luma counter */
    hi_ext_af_hiligh_thre_write(ViPipe, g_stFocusCfg[ViPipe].stConfig.u16HighLumaTh);
    ...
    g_stFocusCfg[ViPipe].stConfig.u16Hsize = hi_ext_sync_total_width_read(ViPipe);
    g_stFocusCfg[ViPipe].stConfig.u16Vsize = hi_ext_sync_total_height_read(ViPipe);
...
HI_S32 ISP_FE_AF_SetDefault(VI_PIPE ViPipe, ISP_REG_CFG_S *pstRegCfg)
{
    HI_U8 u8I, u8Shift0;
    HI_S16 s16G0, s16G1, s16G2;
    ISP_AF_H_PARAM_S *pstIIR;
    ...
    pstAFdefaultCfg   = &pstRegCfg->stAlgRegCfg[0].stFEAfRegCfg;

    u32Cfa = hi_ext_system_rggb_cfg_read(ViPipe);
    pstAFdefaultCfg->u8BayerMode    = (HI_U8)u32Cfa;
    pstAFdefaultCfg->bLpfEnable     = HI_ISP_FE_AF_LPF_EN_DEFAULT;
    pstAFdefaultCfg->bFir0LpfEnable = HI_ISP_FE_AF_FIR0_LPF_EN_DEFAULT;
    pstAFdefaultCfg->bFir1LpfEnable = HI_ISP_FE_AF_FIR1_LPF_EN_DEFAULT;
    pstAFdefaultCfg->u8IirPlgGroup0 = HI_ISP_FE_AF_IIR0_PLG_DEFAULT;
    pstAFdefaultCfg->u8IirPlsGroup0 = HI_ISP_FE_AF_IIR0_PLS_DEFAULT;
    pstAFdefaultCfg->u8IirPlgGroup1 = HI_ISP_FE_AF_IIR1_PLG_DEFAULT;
    pstAFdefaultCfg->u8IirPlsGroup1 = HI_ISP_FE_AF_IIR1_PLS_DEFAULT;
    ...
    pstAFdefaultCfg->u8Iir0Shift    = g_stFocusCfg[ViPipe].stHParam_IIR0.u8IIRShift;
    pstAFdefaultCfg->u8Iir1Shift    = g_stFocusCfg[ViPipe].stHParam_IIR1.u8IIRShift;
    ...
    pstAFdefaultCfg->u16WindowHnum  = g_stFocusCfg[ViPipe].stConfig.u16Hwnd;
    pstAFdefaultCfg->u16WindowVnum  = g_stFocusCfg[ViPipe].stConfig.u16Vwnd;
    ...
    /* AF FE crop */
    pstAFdefaultCfg->bCropEnable    = g_stFocusCfg[ViPipe].stConfig.stCrop.bEnable;
    pstAFdefaultCfg->u16CropPosY    = g_stFocusCfg[ViPipe].stConfig.stCrop.u16Y;
    pstAFdefaultCfg->u16CropPosX    = g_stFocusCfg[ViPipe].stConfig.stCrop.u16X;
    pstAFdefaultCfg->u16CropHsize   = g_stFocusCfg[ViPipe].stConfig.stCrop.u16W;
    pstAFdefaultCfg->u16CropVsize   = g_stFocusCfg[ViPipe].stConfig.stCrop.u16H;

    /* AF FE raw cfg */
    pstAFdefaultCfg->u8AfPosSel     = 0;
    pstAFdefaultCfg->bRawMode       = 0x1;//FE,raw mode only;
    ...
    pstAFdefaultCfg->bOffsetEnable  = 0x1;
    ISP_SensorGetBlc(ViPipe, &pstSnsBlackLevel);
    //BE has subtracted Blacklevel
    pstAFdefaultCfg->u16OffsetGr    = pstSnsBlackLevel->au16BlackLevel[2] << 2;
    pstAFdefaultCfg->u16OffsetGb    = pstSnsBlackLevel->au16BlackLevel[1] << 2;
    ...
    /* high luma counter */
    pstAFdefaultCfg->u8HilighThre       = g_stFocusCfg[ViPipe].stConfig.u16HighLumaTh;
    ...
    pstAFdefaultCfg->u16InputHsize      = g_stFocusCfg[ViPipe].stConfig.u16Hsize;
    pstAFdefaultCfg->u16InputVsize      = g_stFocusCfg[ViPipe].stConfig.u16Vsize;

    //pstAFdefaultCfg->bUpdateMode      = HI_ISP_FE_AF_UPDATE_MODE_DEFAULT;
...
HI_S32 ISP_BE_AF_SetDefault(VI_PIPE ViPipe, ISP_REG_CFG_S *pstRegCfg)
{
    HI_U8 u8BlockNum = 0;
    HI_U8 i;
    HI_U8 u8I, u8Shift0;
    ...
    for (i = 0; i < u8BlockNum; i++)
    {
        ...
        if ((IS_STRIPING_MODE(pstIspCtx->stBlockAttr.enIspRunningMode)) ||
            (IS_SIDEBYSIDE_MODE(pstIspCtx->stBlockAttr.enIspRunningMode)) ||
            (pstIspCtx->stBlockAttr.stFrameRect.u32Height < AF_MIN_HEIGHT ) ||
        ...
        pstAFdefaultCfg->u16InputHsize      = stBlockRect.u32Width;
        pstAFdefaultCfg->u16InputVsize      = stBlockRect.u32Height;

        //pstAFdefaultCfg->bUpdateMode      = HI_ISP_BE_AF_UPDATE_MODE_DEFAULT;
        pstAFdefaultCfg->bUpdate            = 1;
...
HI_S32 AfFeCfgReg(VI_PIPE ViPipe, ISP_REG_CFG_S *pstRegCfg)
{
    ISP_AF_REG_CFG_S    *pstAFdefaultCfg = HI_NULL;
    ISP_CMOS_BLACK_LEVEL_S *pstSnsBlackLevel = HI_NULL;
    pstAFdefaultCfg   = &pstRegCfg->stAlgRegCfg[0].stFEAfRegCfg;
    ...
    pstAFdefaultCfg->u8Iir0Shift    = hi_ext_af_iir0_shift_read(ViPipe);
    pstAFdefaultCfg->u8Iir1Shift    = hi_ext_af_iir1_shift_read(ViPipe);
    pstAFdefaultCfg->enPeakMode     = hi_ext_af_peakmode_read(ViPipe);
    pstAFdefaultCfg->enSquMode      = hi_ext_af_squmode_read(ViPipe);
    pstAFdefaultCfg->u16WindowHnum  = hi_ext_af_window_hnum_read(ViPipe);
    ...
    pstAFdefaultCfg->u16IirSlope1Coring = hi_ext_af_fir_slope1_coring_read(ViPipe);
    ...
    pstAFdefaultCfg->u16InputHsize      = hi_ext_af_input_hsize_read(ViPipe);
    pstAFdefaultCfg->u16InputVsize      = hi_ext_af_input_vsize_read(ViPipe);
...
HI_S32 AfBeCfgReg(VI_PIPE ViPipe, ISP_REG_CFG_S *pstRegCfg)
{
    HI_U8 u8BlockNum = 0;
    HI_U8 i;
    ISP_AF_REG_CFG_S    *pstAFdefaultCfg = HI_NULL;
...
HI_S32 ISP_AfInit(VI_PIPE ViPipe, HI_VOID *pRegCfg)
{
    ...
    ISP_EXT_AF_SetDefault(ViPipe);
    ISP_FE_AF_SetDefault(ViPipe, (ISP_REG_CFG_S *)pRegCfg);
    ISP_BE_AF_SetDefault(ViPipe, (ISP_REG_CFG_S *)pRegCfg);
                 ...
                 HI_VOID *pRegCfg, HI_S32 s32Rsv)
{
    ...
    {
        hi_ext_af_set_flag_write(ViPipe, HI_EXT_AF_SET_FLAG_DISABLE);
        AfFeCfgReg(ViPipe, (ISP_REG_CFG_S *)pRegCfg);
        AfBeCfgReg(ViPipe, (ISP_REG_CFG_S *)pRegCfg);
    }
