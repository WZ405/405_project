...
typedef struct hiPCIV_PIC_S
{
    ...
    HI_U64              u64PhyAddr; /* physical address of video buffer which store pcicture info */
    ...
    HI_BOOL             bBlock;     /* the flag of Block*/
    VIDEO_FORMAT_E      enVideoFormat; /*the style of Video*/
    COMPRESS_MODE_E	    enCompressMode; /*the Mode of Compress*/
...
{
    HI_S32 (*pfnPcivSendPic)(VI_DEV ViDevId, VI_CHN ViChn,const VIDEO_FRAME_INFO_S *pstPic);
