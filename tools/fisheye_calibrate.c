                                    ...
                                    VB_BLK* pstVbBlk, VB_POOL pool)
{
    ...
    *pstVbBlk = VbBlk;
    ...
    pstOutFrame->stVFrame.u64VirAddr[1] = pstOutFrame->stVFrame.u64VirAddr[0] + u32LumaSize;
...
#endif
{
    ...
    printf("NOTICE: This tool only only suport PIXEL_FORMAT_YVU_SEMIPLANAR_420\n");
    printf("NOTICE: This tool only only suport DYNAMIC_RANGE_SDR8\n");
    ...
    u32BlkSize = pstVFramIn->stVFrame.u32Stride[0] * u32Height * 3 / 2;
    /*create comm vb pool*/
