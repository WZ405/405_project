...
HI_S32 DumpLinearBayer(VI_PIPE ViPipe, HI_U32 u32Nbit, HI_U32 u32Cnt, HI_U32 u32ByteAlign, HI_U32 u32RatioShow)
{
...
HI_S32 DumpWDRBayer(HI_U32 u32PipeNum, VI_PIPE ViPipeId[], HI_U32 u32Nbit, HI_U32 u32Cnt, HI_U32 u32ByteAlign, HI_U32 u32RatioShow)
{
    HI_S32                 s32Ret        = HI_SUCCESS;
    int                    i, j, k;
    ...
    ISP_PUB_ATTR_S         stPubAttr;
    ISP_FRAME_INFO_S*      pstIspFrameInfo;
    VIDEO_FRAME_INFO_S*    pastFrame[4] =  {0};
    VB_SUPPLEMENT_CONFIG_S stSupplementConfig;
...
#endif
{
    ...
    for (i = 0; i < stDevBindPipe.u32Num; i++)
    {
        ...
        stPipeAttr.enPixFmt = stPixelFrt;
    ...
    {
        DumpLinearBayer(ViPipe, u32Nbit, u32FrmCnt, u32ByteAlign, u32RatioShow);
    }
    else
    {
        DumpWDRBayer(stDevBindPipe.u32Num, stDevBindPipe.PipeId, u32Nbit, u32FrmCnt, u32ByteAlign, u32RatioShow);
    }
